...
public class AnswerController {
    ...
    public String modifyAnswer(@PathVariable("id") Long id, @Valid AnswerForm answerForm, Principal principal, BindingResult bindingResult){
        if(bindingResult.hasErrors()){
            return "answer_form";
        }
        Answer answer = this.answerService.getAnswer(id);
    ...
    public String answerDelete(Principal principal, @PathVariable("id") Long id) {
        ...
        return String.format("redirect://question/details/%s", answer.getQuestion().getId());
    }
